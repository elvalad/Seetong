...
//		}
        ...
        if (Define.LOGIN_TYPE_USER == Global.m_loginType) {
            ...
            tools.setGuideImage(R.id.layout_main, imgs, "main_video", new GuideTools.IGuideFinish() {
                ...
                public void onFinish() {
                    ...
                    com.seetong.app.seetong.model.Settings s = com.seetong.app.seetong.model.Settings.findByUser(Global.m_devInfo.getUserName());
                    if (null == s) return;
    ...
    public void saveSettings() {
        ...
        com.seetong.app.seetong.model.Settings s = new com.seetong.app.seetong.model.Settings();
