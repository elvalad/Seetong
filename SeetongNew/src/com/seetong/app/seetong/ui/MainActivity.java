...
import com.seetong.app.seetong.model.Settings;
...
//		}
        ...
        if (Define.LOGIN_TYPE_USER == Global.m_loginType) {
            ...
            tools.setGuideImage(R.id.layout_main, imgs, "main_video", new GuideTools.IGuideFinish() {
                ...
                public void onFinish() {
                    ...
                    Settings s = Settings.findByUser(Global.m_devInfo.getUserName());
                    if (null == s) return;
    ...
    public void saveSettings() {
        ...
        com.seetong.app.seetong.model.Settings s = new Settings();
