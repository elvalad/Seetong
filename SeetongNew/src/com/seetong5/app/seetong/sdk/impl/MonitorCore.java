...
public class MonitorCore {
    ...
    public List<com.seetong5.app.seetong.model.Device> m_local_dev_list = new ArrayList<>();
    ...
    public void loadDevice() {
        m_local_dev_list = com.seetong5.app.seetong.model.Device.findAll();
        for (com.seetong5.app.seetong.model.Device d : m_local_dev_list) {
    ...
    class DirectConnectCB implements FunclibAgent.IDirectConnectCB, PlayCtrlAgent.IPlayCtrlAgentCB {
        ...
        public int SearchIPC(int nEventCode, int index, NetSDK_IPC_ENTRY entry) {
            ...
            addDeviceToList(dev);
            com.seetong5.app.seetong.model.Device d = new com.seetong5.app.seetong.model.Device();
