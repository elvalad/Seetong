...
public class CloudEndRecord extends BaseActivity implements GestureDetector.OnGestureListener, View.OnClickListener, View.OnTouchListener {
    ...
    protected void initWidget() {
        ...
        m_time_line.updSliderTimestamp(System.currentTimeMillis());
    ...
    private void onBtnCalendar() {
        ...
        final com.seetong5.app.seetong.ui.aid.CalendarView calendar = (com.seetong5.app.seetong.ui.aid.CalendarView) vi.findViewById(R.id.calendar);
        calendar.setOnItemClickListener(new com.seetong5.app.seetong.ui.aid.CalendarView.OnItemClickListener() {
            @Override
...
//		findViewById(R.id.Linear_Fourview).setPadding(width, width, width, width);
    ...
    private void onReplaySetPosition(Message msg) {
        ...
        m_time_line.updSliderTimestamp(time);
    }
