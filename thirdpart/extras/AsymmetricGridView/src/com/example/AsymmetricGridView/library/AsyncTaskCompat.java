...
public abstract class AsyncTaskCompat<Params, Progress, Result> {
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link com.example.AsymmetricGridView.library.AsyncTaskCompat#onPostExecute} has finished.
         */
        FINISHED,
    }
     ...
     *         {@link com.example.AsymmetricGridView.library.AsyncTaskCompat.Status#RUNNING} or {@link com.example.AsymmetricGridView.library.AsyncTaskCompat.Status#FINISHED}.
     *
     ...
     * AsyncTaskCompat, however you can also use your own {@link java.util.concurrent.Executor} for custom
     * behavior.
     * 
     * <p><em>Warning:</em> Allowing multiple tasks to run in parallel from
     * a thread pool is generally <em>not</em> what one wants, because the order
